...
use crate::deform_uniforms::{
    extract_outline_deform_uniforms, prepare_outline_deform_bind_group, OutlineDeformUniform,
};
use crate::draw::{
    ...
    fn build(&self, app: &mut App) {
        ...
        .add_systems(
            ...
            (
                ...
                extract_outline_deform_uniforms,
            ),
        )
        .add_systems(
            Render,
            (
                ...
                prepare_outline_deform_bind_group,
            )
