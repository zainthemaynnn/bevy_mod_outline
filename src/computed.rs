...
use crate::{
    uniforms::DepthMode, InheritOutline, OutlineDeform, OutlineMode, OutlineStencil, OutlineVolume,
};
...
#[derive(Clone, Default)]
pub(crate) struct ComputedDeform {
    pub(crate) seed: f32,
}
...
pub(crate) struct ComputedInternal {
    ...
    pub(crate) deform: Sourced<ComputedDeform>,
}
